...
use super::gmail_mime::{
    build_draft_raw, build_raw_message, parse_address_list, parse_email_header,
};
use super::http_client_with_proxy;
use crate::parser::{AttachmentData, AttachmentMeta};
use pebble_core::traits::*;
use pebble_core::{
    new_id, now_timestamp, DraftMessage, Folder, FolderRole, FolderType, HttpProxyConfig, Message,
...
mod tests {
    use super::*;
    use crate::provider::gmail_mime::format_address;
