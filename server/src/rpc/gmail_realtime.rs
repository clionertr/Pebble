...
pub(crate) async fn get_gmail_realtime_config(
...
pub(crate) async fn enable_gmail_realtime(
    state: State<Arc<AppState>>,
    account_id: String,
...
pub(crate) async fn disable_gmail_realtime(
    state: State<Arc<AppState>>,
    account_id: String,
) -> std::result::Result<GmailRealtimeConfig, PebbleError> {
...
pub(crate) async fn update_gmail_realtime_config(
    state: State<Arc<AppState>>,
    account_id: String,
